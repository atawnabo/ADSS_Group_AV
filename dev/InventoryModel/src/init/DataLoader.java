...
public class DataLoader {
    ...
    public void load() {
        ...
        // ==================== ITEM TYPES ====================
        // signature: name, Location, minQuantity, costPrice, sellingPrice, categoryId, manufacturer

        // Dairy
        pc.addItemType("Milk 3% Tnuva 1L",   new Location(1, 1), 20,  4,  6,  3,  "Tnuva");
        pc.addItemType("Milk 1% Tnuva 1L",   new Location(1, 2), 20,  4,  6,  4,  "Tnuva");
        pc.addItemType("Milk 5% Tnuva 1L",   new Location(1, 3), 15,  4,  7,  5,  "Tnuva");
        pc.addItemType("Yellow Cheese 200g",  new Location(2, 1), 10,  8, 12,  7,  "Tnuva");
        pc.addItemType("White Cheese 200g",   new Location(2, 2), 10,  6,  9,  8,  "Tnuva");
        pc.addItemType("Butter 250g",         new Location(2, 3),  8,  6,  9, 10,  "Tnuva");
        pc.addItemType("Butter 500g",         new Location(2, 4),  5, 11, 16, 11,  "Tnuva");

        // Hygiene
        pc.addItemType("Pinuk Shampoo 250ml", new Location(3, 1),  8,  8, 14, 14, "Pinuk");
        pc.addItemType("Pinuk Shampoo 500ml", new Location(3, 2),  5, 14, 22, 15, "Pinuk");
        pc.addItemType("Dove Soap Bar",       new Location(3, 3), 10,  3,  6, 17, "Dove");
        pc.addItemType("Dove Soap Liquid",    new Location(3, 4),  8,  7, 12, 18, "Dove");

        // Beverages
        pc.addItemType("Prigat Orange Juice", new Location(4, 1), 15,  4,  7, 21, "Prigat");
        pc.addItemType("Prigat Apple Juice",  new Location(4, 2), 15,  4,  7, 22, "Prigat");
        pc.addItemType("Water 500ml",         new Location(4, 3), 30,  1,  3, 24, "Neviot");
        pc.addItemType("Water 1.5L",          new Location(4, 4), 20,  2,  5, 25, "Neviot");

        // Bakery
        pc.addItemType("White Bread",         new Location(5, 1), 10,  3,  6, 28, "Berman");
        pc.addItemType("Whole Wheat Bread",   new Location(5, 2), 10,  4,  7, 29, "Berman");

        // Snacks
        pc.addItemType("Regular Chips 100g",  new Location(6, 1), 20,  3,  6, 32, "Elite");
        pc.addItemType("Baked Chips 100g",    new Location(6, 2), 15,  4,  7, 33, "Elite");
        pc.addItemType("Dark Chocolate 100g", new Location(6, 3), 10,  5,  9, 35, "Elite");
        pc.addItemType("Milk Choc 100g",      new Location(6, 4), 12,  4,  8, 36, "Elite");
        ...
        pc.addSupplierDiscount(1, 10.0, LocalDate.of(2026, 3, 1),  "Tnuva");
        pc.addSupplierDiscount(2,  8.0, LocalDate.of(2026, 3, 15), "Tnuva");
        pc.addSupplierDiscount(8,  5.0, LocalDate.of(2026, 4, 1),  "Pinuk");
    }
}